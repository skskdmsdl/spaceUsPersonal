...
<section class="ftco-section ftco-agent">
	<div class="container">
		<div
			class="col-md-12 heading-section text-center ftco-animate mb-5 mt-5">
				...
				<div class="row m-5">
					<div class="col-lg-12">
						<div class="property-submit-form">
							<form name="exhibitionFrm"
								action="${pageContext.request.contextPath}/exhibition/insertExhibition.do">
								<div class="pf-title">
									<h4>
										기획전 제목<span class="text-danger">*</span>
									</h4>
								...
								<divclass"pf-feature-price">
								<h4>
									공간 태그<span class="text-danger">*</span>
								</h4>
								<div class="row">
									<div class="ml-3 mb-5 wrapper" style="width: 31%">
										<select size="30" name="tagNo"
											class="selection nice-select sm-width">
						...
						<div class="pf-title">
							<h4>
								이미지 등록<span class="text-danger">*</span>
							</h4>
						</div>
						...
						<input type="hidden" name="imageUrl" id="imageUrl" /> <input
							type="hidden" name="renamedFileName" id="renamedFileName" />
