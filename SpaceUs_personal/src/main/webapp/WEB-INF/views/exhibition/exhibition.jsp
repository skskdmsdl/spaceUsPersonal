	...
	<div class="container">
		<div
			...
			<sec:authorize access="hasRole('ADMIN')">
				<h1 class="text-right" style="height: 40px;">
					<a
						href="${pageContext.request.contextPath}/exhibition/insertExhibitionFrm.do">+</a>
				</h1>
			</sec:authorize>
		</div>
		<div class="row">
				...
				<div class="col-md-4">
					<sec:authorize access="hasRole('ADMIN')">
						<button type="button" class="btn btn-outline-danger"
							onclick="deleteEx('${ list.exNo }');">삭제</button>
						<br />
					</sec:authorize>
					<div class="agent space1"
						onclick="exhibitionList('${list.tagNo}');">
						<div class="img">
							...
							<c:if test="${ not empty list.renamedFileName }">
								<img
									src="${pageContext.request.contextPath}/resources/upload/exhibition/${ list.renamedFileName  }">
							</c:if>
						</div>
						<div class="desc">
							<h3>${ list.exTitle }</h3>
