...
<script src="https://kit.fontawesome.com/b74a25ff1b.js"
...
<input type="hidden" id="result"
	value="${member.nickName =='관리자'?'SpaceUs':'회원'}" />
<script>
...
<div class="skin-default-dark fixed-layout">
	<div class="preloader">
		<div class="loader">
			...
			<p class="loader__label">쪼매만 기다리쇼..
			<p>
		</div>
	</div>
	<!-- ============================================================== -->
	...
	<div id="main-wrapper">
		...
		<div id="talkjs-container"
			style="background-color: rgba(0, 0, 0, 0); margin-left: 40%; margin-top: 10%; height: 500px; position: fixed; z-index: 10; box-shadow: rgba(0, 0, 0, 0.5) 0 0 0 9999px; display: none;">
			<i>Loading chat...</i>
		</div>
		<div>
		...
		<header class="topbar">
			<nav class="navbar top-navbar navbar-expand-md navbar-light">
				<div class="navbar-header">
					<a style="color: black" class="navbar-brand"
						href="${pageContext.request.contextPath }">Space Us</a>
				</div>
		...
		<aside class="left-sidebar">
			<div class="d-flex no-block nav-text-box align-items-center">
				<span>Management</span> <a
					class="waves-effect waves-light ml-auto hidden-sm-down"
					href="javascript:void(0)"><i class="ti-menu"></i></a> <a
					class="nav-toggler waves-effect waves-light ml-auto hidden-sm-up"
			...
			<div class="scroll-sidebar">
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						<li><a class="waves-effect" id="memberManageBtn"
							aria-expanded="false"
							href="${pageContext.request.contextPath }/admin/memberManage.do"><i
								class="fa fa-user"></i><span class="hide-menu">회원 관리</span></a></li>
						<li><a class="waves-effect " id="spaceApprovalBtn"
							aria-expanded="false"
							href="${pageContext.request.contextPath }/admin/spaceManage.do"><i
								class="fa fa-home"></i><span class="hide-menu">공간승인</span></a></li>
						<li><a class="waves-effect " id="blackListBtn"
							aria-expanded="false"
							href="${pageContext.request.contextPath }/admin/blackListManage.do"><i
								class="fa fa-ban"></i><span class="hide-menu">블랙리스트 관리</span></a></li>
					</ul>
				</nav>
								...
								<div class="row"
									...
									<div class="search-container" style="display: inline;">
										...
										<div id="search-userId">
											<form
												action="${pageContext.request.contextPath}/admin/findUserList.do">
												<input type="hidden" class="textbox" name="searchType"
													value="userId"> <input type="text" class="textbox"
													name="searchKeyword" size="25" placeholder="검색할 이메일을 입력하세요"
													style="border-radius: 5px; size: portrait;" />
												<button type="submit"
													class="search-btn button btn btn-secondary">검색</button>
											</form>
										</div>
										<div id="search-userName">
											<form
												action="${pageContext.request.contextPath}/admin/findUserList.do">
												<input type="hidden" class="textbox" name="searchType"
													value="userName"> <input type="search"
													class="textbox" name="searchKeyword" size="25"
													placeholder="검색할 닉네임을 입력하세요." style="border-radius: 5px;" />
									...
									<div class="btn-div"
										...
										<form
											action="<%=request.getContextPath()%>/admin/findUserList.do">
											<input type="hidden" name="searchType" value="userRole" />
											<button type="submit" class="btn" name="searchKeyword"
												value="total" style="background: #019efb; color: #fff;">전체
												보기</button>
											<button type="submit" class="btn" name="searchKeyword"
												value="ROLE_USER" style="background: #37bea6; color: #fff;">일반
												맴버</button>
											<button type="submit" class="btn" name="searchKeyword"
												value="ROLE_HOST" style="background: #ffbc34; color: #fff;">호스트</button>
										</form>
									</div>
									...
									<c:forEach items="${memberList}" var="member" varStatus="vs">
										<tr>
											...
											<td><a href="#" class="settings" title="Settings"
												data-toggle="tooltip"> <i class="fas fa-cog"></i>
											</a> <a href="#" class="delete" title="Delete"
												data-toggle="tooltip"> <i class="fas fa-minus-circle">&#xE5C9;</i>
											</a></td>
										</tr>
									</c:forEach>
								</tbody>
