						...
						<div class="card-body">
							...
							<div class="row">
								<c:forEach items="${spaceList}" var="space">
									<div class="col-md-3 spaceOne"
										style="padding: 20px; margin: 70px;">
										<div class="spaceTwo">
											<div class="thumbnail block-20" style="margin: 0 auto;">
												<c:if test="${not empty space.renamedFilename}">
													<img class="block-20"
														src="${ pageContext.request.contextPath}/resources/upload/space/${space.renamedFilename}"
														alt="...">
												</c:if>
												<c:if test="${empty space.renamedFilename}">
													<img class="block-20"
														src="${ pageContext.request.contextPath}/resources/upload/space/noimage.gif"
														alt="...">
												</c:if>
											</div>
											<div class="caption" style="text-align: center;">
												...
												<h6 style="margin: 10px 0;">
													<strong>등록 요청일</strong>: ${space.registrationDate}
												</h6>
												<h6 style="margin: 10px 0;">
													<strong>유저 이메일</strong>: ${space.memberEmail}
												</h6>
											</div>
										</div>
