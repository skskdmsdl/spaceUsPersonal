			...
			<div class="col-lg-12">
				<div class="property-submit-form">
					<form:form name="spaceFrm" id="spaceFrm"
						...
						<div class="pf-title">
							<h4>
								공간이름<span class="text-danger">*</span>
							</h4>
							<input type="text" name="spaceName" id="spaceName">
						</div>
						<div class="pf-summernote">
							<h4>
								공간설명<span class="text-danger">*</span>
							</h4>
							<textarea id="content" name="content"
								style="width: 100%; height: 350px; border: 1px solid #ebebeb; resize: none;"></textarea>
						</div>

						<div class="pf-location">
							<h4>
								공간주소<span class="text-danger">*</span>
							</h4>
							<div style="display: inline-block; width: 40%">
								<input class="zipCode-input" id="sample6_postcode" type="text"
									placeholder="우편번호" />
							</div>
							<div style="display: inline-block; width: 40%">
								<button type="button"
									class="btn btn-primary ml-4 pr-4 pl-4 p-10"
									onclick="sample6_execDaumPostcode()">주소 검색</button>
							</div>
							<input class="address-input mt-4" type="text"
								id="sample6_address">
							<div style="display: inline-block; width: 48.5%">
								<input class="detail-address-input" type="text"
						...
						<div class="pf-phone" style="margin-bottom: 45px;">
							<h4>
								공간전화번호<span class="text-danger">*</span>
							</h4>
							<input type='tel' id='phone1' style="width: 10%" />&emsp;ㅡ&emsp;
							<input type='tel' id='phone2' style="width: 10%" />&emsp;ㅡ&emsp;
							<input type='tel' id='phone3' style="width: 10%" /> <input
								type="hidden" name="spacePhone" value="" />
						</div>
						<div class="pf-type">
							<h4>
								카테고리 선택<span class="text-danger">*</span>
							</h4>
						...
						<div class="pf-status" id="time">
							<h4>
								가능시간<span class="text-danger">*</span>
							</h4>


							<div class="jumbotron pb-1 pt-1 status-item" id="day">
								<label for="mon" class="mr-5" style="font-size: 15px;">월요일
									<input type="radio" name="radio" id="mon"> <span
									class="checkbox mt-1"></span>
								</label> <label for="tue" class="mr-5" style="font-size: 15px;">화요일
									<input type="radio" name="radio" id="tue"> <span
									class="checkbox mt-1"></span>
								</label> <label for="wed" class="mr-5" style="font-size: 15px;">수요일
									<input type="radio" name="radio" id="wed"> <span
									class="checkbox mt-1"></span>
								</label> <label for="thu" class="mr-5" style="font-size: 15px;">목요일
									<input type="radio" name="radio" id="thu"> <span
									class="checkbox mt-1"></span>
								</label> <label for="fri" class="mr-5" style="font-size: 15px;">금요일
									<input type="radio" name="radio" id="fri"> <span
									class="checkbox mt-1"></span>
								</label> <label for="sat" class="mr-5" style="font-size: 15px;">토요일
									<input type="radio" name="radio" id="sat"> <span
									class="checkbox mt-1"></span>
								</label> <label for="sun" class="mr-5" style="font-size: 15px;">일요일
									<input type="radio" name="radio" id="sun"> <span
									class="checkbox mt-1"></span>
								</label>
							</div>
						...
						<div class="pf-feature-price">
							<h4>
								공간 태그<span class="text-danger">*</span>
							</h4>
							...
							<div class="row">
								...
								<div>
									<button id="addTags" type="button"
										class="btn btn-primary ml-4 pr-4 pl-4 p-10">추가 ⅴ</button>
								</div>
								<div id="refreshBtn" style="cursor: pointer; display: none;">
									<i class="fa fa-refresh ml-4 mt-4"></i>초기화
								</div>
							</div>
						...
						<div class="pf-feature-price">
							<h4>
								가격 (시간당)<span class="text-danger">*</span>
							</h4>
							<div class="fp-inputs">
								<input id="hourlyPrice" name="hourlyPrice" type="number"
						...
						<div class="pf-feature-image">
							<h4>
								공간이미지<span class="text-danger">*</span>
							</h4>
							<div class="row">
								<div class="image-div">
									<i class="fas fa-plus"></i> <img id="preImage0"
										style="object-fit: cover; width: 100%; height: 200px;" />
								</div>
								<div class="image-div">
									<div>
										<i class="fas fa-plus"></i> <img id="preImage1"
											style="object-fit: cover; width: 100%; height: 200px;" />
									</div>
								</div>
								<div class="image-div">
									<div>
										<i class="fas fa-plus"></i> <img id="preImage2"
											style="object-fit: cover; width: 100%; height: 200px;" />
									</div>
								</div>
							</div>
							<input type="file" name="upFile" class="upFile f0" /> <input
								type="file" name="upFile" class="upFile f1" /> <input
								type="file" name="upFile" class="upFile f2" />
						</div>
						<div class="pf-feature-price">
							<h4>
							...
							<div class="row">
								<div class="ml-3 mb-3" style="width: 31%">
									<input name="businessNo" id="businessNo" type="text"
										placeholder="사업자 번호를 입력해주세요">
								</div>
								<div class="pt-2">
									<span id="error" class="ml-4 text-danger">유효하지 않은 번호입니다.</span>
									<span id="duplicate" class="ml-4 text-danger">이미 등록된
										번호입니다.</span> <span id="ok" class="ml-4 text-primary">사용가능한
										번호입니다.</span> <input type="hidden" id="idValid" value="0" />
						...
						<div class="pf-feature-price">
							<h4>
								계좌정보<span class="text-danger">*</span>
							</h4>
							<div class="row ml-1">
								<select name="bank" id="bank"
									style="height: 46px; width: 100px; border-color: #eaeaea;">
