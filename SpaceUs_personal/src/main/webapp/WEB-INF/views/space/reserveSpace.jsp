			...
			<div class="col-lg-8">
				<div class="blog-item-list">
					<div class="blog-item large-blog">
						<div class="bi-pic">
							<img
								src="${pageContext.request.contextPath }/resources/img/blog/blog-1.jpg"
								alt="">
						</div>
						...
						<table id="tbl-reserve2" class="table table-striped table-hover">
							...
							<tr>
								<th>예약 날짜</th>
								<th><input type="date" id="D-day"
									onchange="selectDay(this.value)"></th>
							</tr>
							<tr>
								<th>예약 시간</th>
								<th>
						...
						<table id="tbl-reserve3" class="table table-striped table-hover">
							...
							<tr>
								<td><input type="radio" name="selectPay" id="pay"
									value="카드결제" /> <label>카드결제</label></td>
								<td><input type="radio" name="selectPay" value="카카오페이" />
									<label>카카오페이</label></td>
							</tr>
						</table>
						<table id="tbl-reserve4" class="table table-striped table-hover">
							...
							<tr>
								<td><select size="1" name="coupon" id="coupon"
									onchange="discount()">
										<option id="no" value="no" select>쿠폰 없음</option>
										<c:forEach items="${couponList}" var="info">
											<option id="${info.no}" value="${info.no}">${info.type}
												<fmt:formatNumber value="${info.discount}" type="percent" />
												[만료일 : ${info.deadLine}]
											</option>
										</c:forEach>
								</select></td>
						...
						<table id="tbl-reserve5" class="table table-striped table-hover">
							...
							<tr>
								<td><input type="checkbox" name="agree" id="agree1" /> <label>위
										공간의 예약조건 확인 및 결제진행 동의 (필수)</label></td>
							</tr>
							<tr>
								<td><input type="checkbox" name="agree" id="agree2" /> <label>개인정보
										제3자 제공 동의 (필수)</label></td>
							</tr>
							<tr>
								<td><input type="checkbox" name="agree" id="agree3" /> <label>개인정보
										수집 및 이용 동의 (필수)</label></td>
							</tr>
						</table>
					</div>
				</div>
					...
					<div class="subscribe-form">
						...
						<form:form name="insertReservation" id="insertReservation"
							...
							<input type="hidden" name="revNo"
								value="${space.spaceNo}${member.memberEmail}">
							...
							<div class="filter-input">
								<p>예약 시간</p>
								<input type="text" name="startHour" value="" style="width: 45%;"
									readonly> ~ <input type="text" name="endHour" value=""
