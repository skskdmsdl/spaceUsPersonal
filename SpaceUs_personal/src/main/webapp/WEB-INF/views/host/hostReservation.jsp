											...
											<div class="row"
												...
												<div class="search-container" style="display: inline;">
													...
													<div class="row">
														...
														<div class="font-bold mr-4 ml-5 align-self-center">회원
															조회</div>
														<div id="search-userId" class="input-group-prepend">
															<form
																action="${ pageContext.request.contextPath }/host/hostSearchReservation.do"
																class="input-group-prepend">
																<input type="text" class="input-group-text"
																	name="memberEmail" id="searchKeyword" size="25"
																	placeholder="검색할 이메일을 입력하세요"
																	style="border-radius: 5px; size: portrait;" />
																<button type="submit"
																	class="search-btn button btn btn-secondary ml-2">검색</button>
															</form>
														</div>
													</div>
												...
												<div class="btn-div"
													...
													<form
														action="${pageContext.request.contextPath }/host/hostReservationOrder.do">
														<button type="submit" class="btn" name="order" value="all"
															style="background: #019efb; color: #fff;">예약일순</button>
														<button type="submit" class="btn mr-3" name="order"
															value="rev" style="background: #ffbc34; color: #fff;">이용일순</button>
													</form>
												</div>
												...
												<c:forEach items="${list}" var="reservation" varStatus="vs">
													<tr>
														...
														<td class="text-center"><fmt:formatDate
																value="${reservation.revDate}" pattern="yy.MM.dd" /></td>
														<td class="text-center"><fmt:formatDate
																value="${reservation.day}" pattern="yy.MM.dd" /></td>
														<td class="text-center">${reservation.startHour}시-
															${reservation.endHour}시</td>
														<td class="text-center">${ reservation.revCancle == 0 ? "-" : "취소" }
														</td>
													</tr>
												</c:forEach>
											</tbody>
