					...
					<div id="qna-wrapper" class="row">
						<div class="col-md-11">
							...
							<div class="qna-filter-container">
								<button id="show-unreplied" class="btn btn-secondary btn-sm"
									type="button" style="background-color: #00c89e;"
									onclick="unreplied();" value="${member.memberEmail}">
									<i id="check-unreplied"></i> ${member.nickName }님의 답변을 기다리는 질문
								</button>
								...
								<c:choose>
													...
													<div class="blog-entry justify-content-end">
														<div class="text">
															...
															<div class="spec"
																...
																<fmt:formatDate value="${ qna.date }"
																	pattern="yyyy-MM-dd" />
																<c:choose>
																	<c:when test="${ qna.status == false }">
																		<a class="meta-chat"><span class="fa fa-unlock"
																			style="color: #FFC107;"></span>공개</a>
																	</c:when>
																	<c:otherwise>
																		<a class="meta-chat"><span class="fa fa-lock"
																			style="color: #20c997;"></span>비공개</a>
																	</c:otherwise>
																</c:choose>
															</div>
															...
															<div class="qnaToggle">
																<div class="row qDetailBtn" style="cursor: pointer;">
																	...
																	<p class="pl-5 pr-5" id="qna-content">
																		...
																		${ fn:substring(str, 0, 40) }
																	</p>
																	<p style="margin: 20px 30px; font-weight: 600;"
																		class="detailBtn">
																		<i class="fa fa-caret-down"></i>더보기
																	</p>
																</div>
																<div class="qSimpleBtn"
																	style="cursor: pointer; display: none; height: 100%">
																	<div class="pl-5 pr-5 qSimple">
																		<p>${ qna.content }</p>
																		<p style="font-weight: 600;" class="simpleBtn">
																			<i class="fa fa-caret-up"></i>접기
																		</p>

																	</div>
																	<!-- 답변 -->
																	<div class="commentBox"
																		style="background-color: #fafafa; cursor: default; border: 1px solid #edeceb; padding-bottom: 30px; margin-left: 30px;">
																		<div class="pl-5 pr-5 pt-4 commentBox">
																			<p class="commentBox">
																				<i class="fa fa-comment mr-1 commentBox"></i>답변
																			</p>
																			<c:choose>
																				<c:when test="${ qna.answer != null }">
																					<div class="modifyFrm">
																						...
																						<button type="button"
																							class="btn btn-secondary commentBox modifyBtn"
																							style="margin-left: 95%;">수정</button>
																					</div>
																					<div class="row commentBox modifyDiv"
																						style="height: 110px;">
																						<input type="hidden" name="reviewNo"
																							value="${ qna.qnaNo }" />
																						<textarea class="ml-2 mr-1 mt-1 commentBox answer"
																							style="resize: none; border: 1px solid #edeceb; height: 80px; border-radius: 4px; width: 85%">${ qna.answer }</textarea>
																						<button type="button"
																							class="btn mt-1 commentBox updateAnswer"
																							style="margin-bottom: 70px; height: 80px; border: 1px solid #dddddd; width: 60px;">등록</button>
																					</div>
																				</c:when>
																				<c:otherwise>
																					<div class="row commentBox" style="height: 110px;">
																						<input type="hidden" name="reviewNo"
																							value="${ qna.qnaNo }" />
																						<textarea
																							class="col ml-2 mr-1 mt-1 commentBox answer"
																							style="resize: none; border: 1px solid #edeceb; height: 80px; border-radius: 4px;"></textarea>
																						<button type="button"
																							class="btn mt-1 commentBox updateAnswer"
																							style="margin-bottom: 70px; height: 80px; border: 1px solid #dddddd; width: 60px;">등록</button>
																					</div>
									...
									<c:otherwise>
										<div style="text-align: center; width: 90%; padding: 20px;">
											<span class="icon-folder" style="letter-spacing: 1px;">
												등록된 질문글이 없습니다.</span>
										</div>
									</c:otherwise>
								</c:choose>
...
<script
	src="${ pageContext.request.contextPath }/resources/assets/node_modules/raphael/raphael-min.js"></script>
<script
	src="${ pageContext.request.contextPath }/resources/assets/node_modules/morrisjs/morris.min.js"></script>
<script
	src="${ pageContext.request.contextPath }/resources/assets/node_modules/jquery-sparkline/jquery.sparkline.min.js"></script>
<!--c3 JavaScript -->

<script
	src="${ pageContext.request.contextPath }/resources/assets/node_modules/d3/d3.min.js"></script>
<script
	src="${ pageContext.request.contextPath }/resources/assets/node_modules/c3-master/c3.min.js"></script>
<!-- Chart JS -->
<script
