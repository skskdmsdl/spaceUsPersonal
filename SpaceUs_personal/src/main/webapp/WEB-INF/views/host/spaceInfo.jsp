				...
				<div class="card-body">
					...
					<table class="col-11">
						<tr>
							...
							<th><input type="text"
								class="col-8 input-group-text mb-4 pull-right"
								value="${space.spaceName }" readonly /></th>
						</tr>
						<tr>
							<td class="align-baseline">공간 설명</td>
							<td><textarea rows="5" cols="10"
									class="col-8 mb-4 pull-right" readonly>${space.content}
						      	  </textarea></td>
						</tr>
						<tr>
							...
							<td><input type="text"
								class="col-8 input-group-text mb-4 pull-right"
								value="${space.spacePhone }" readonly /></td>
						</tr>
						<tr>
							<td class="align-baseline">카테고리</td>
							<td><input type="text"
								class="col-8 input-group-text mb-4 pull-right"
								value="${cateName}" readonly /></td>
						</tr>
						<tr>
							<td class="align-baseline">사업자 번호</td>
							<td><input type="number"
								class="col-8 input-group-text mb-4 pull-right"
								value="${space.businessNo }" readonly /></td>
						</tr>
						<tr>
							<td class="align-baseline">주소</td>
							<td><input type="text"
								class="col-8 input-group-text mb-4 pull-right" maxlength="11"
								value="${space.address }" readonly /></td>
						</tr>
					</table>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab">
							<a role="button" id="updateTitle" data-toggle="collapse"
								data-parent="#accordion" href="#collapse1" aria-expanded="false"
								style="color: #666;"> 공간 수정 </a>
						</div>
								...
								<table class="col-11">
									<tr>
										...
										<td>
											...
											</table> <input type="hidden" name="optionNo" value="" />
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											</table> <input type="hidden" name="day" value="" />
										</td>
									</tr>
									<tr>
										<td class="align-baseline">공개여부</td>
										<td><input type="radio" id="open" name="status"
											class="col-8 input-group-text ml-auto mb-5" value="O"
											style="display: inline;"
											<c:if test="${space.status eq 'O'}">checked</c:if>> <label
											for="open" style="display: inline;">공개</label><br> <input
											type="radio" id="close" name="status"
											class="col-8 input-group-text ml-auto mb-5" value="C"
											style="display: inline;"
											<c:if test="${space.status eq 'C'}">checked</c:if> /> <label
											for="close" style="display: inline;">비공개</label><br></td>
									</tr>
									<tr>
										<td></td>
										<td><input type="hidden" name="spaceNo"
											value="${space.spaceNo}" />
											<div class="mt-5 pull-right">
												<input type="submit"
													class="btn btn-outline-success btn-lg p-3 pl-4 pr-4"
													value="정보 수정">&nbsp; <a role="button"
													data-toggle="collapse" data-parent="#accordion"
													href="#collapse1"
													class="btn btn-outline-secondary btn-lg p-3 pl-4 pr-4">취소</a>
											</div></td>
									</tr>
								</table>
							</form:form>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab">
							<a role="button" id="deleteTitle" data-toggle="collapse"
								data-parent="#accordion" href="#collapse2" aria-expanded="false"
								style="color: #666;"> 공간삭제 </a>
						</div>
						<div id="collapse2" class="panel-collapse collapse mr-5"
							role="tabpanel">
							<br />
							<div class="panel-body">
								삭제하시면 모든 정보가 삭제됩니다.<br />정말로 삭제하시겠습니까?
							</div>
							<a role="button" data-toggle="collapse" data-parent="#accordion"
								href="#collapse2"
								class="btn btn-outline-secondary font-bold mr-3 pull-right">취소</a>
							<button id="deleteBtn"
								class="btn btn-danger font-bold mr-2 pull-right">삭제</button>
							<form
								action="${pageContext.request.contextPath }/space/deleteSpace.do"
								id="deleteFrm">
