				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-2">
							...
							<form
								action="${pageContext.request.contextPath}/host/selectReviewComment.do"
								id="selectCommentFrm">
								<input type="hidden" name="spaceNo" value="${ spaceNo }" />
							</form>
							<form
								action="${pageContext.request.contextPath}/host/reviewList.do"
								id="totalCommentFrm"></form>
						</div>
					</div>
					<div>
						<div class="row">
							...
							<c:when test="${ not empty review }">
								<c:forEach items="${review}" var="review" varStatus="vs">
									<c:choose>
												...
												<div class="desc" style="width: 100%;">
													...
													<div class="reviewToggle">
														<div class="row reviewDetailBtn" style="cursor: pointer;">
															<div
																style="background-image: url(${pageContext.request.contextPath}/resources/upload/review/${review.image}); background-size: cover; width:180px; height: 150px;margin-left: 10px;"></div>
															<p
																style="position: absolute; margin: 10px 85px 0 215px; overflow: hidden; text-overflow: ellipsis; width: 60%; -webkit-box-orient: vertical; -webkit-line-clamp: 3; display: -webkit-box;">${ review.content }</p>
															<p style="margin: 105px 0 0 25px; font-weight: 600;"
														...
														<div class="reviewSimpleBtn"
															...
															<div class="reviewSimple">
																...
																<div
																	style="background-image: url(${pageContext.request.contextPath}/resources/upload/review/${review.image});  width: 500px;height: 350px;background-size: cover; margin-bottom:30px;"></div>
															</div>
															<!-- 댓글 -->
															<div class="commentBox"
																style="background-color: #fafafa; cursor: default; border: 1px solid #edeceb; padding-bottom: 30px;">
																<div class="pl-5 pr-5 pt-4 commentBox">
																	<p class="commentBox">
																		<i class="fa fa-comment mr-1 commentBox"></i>댓글
																	</p>
																	<c:choose>
																		<c:when test="${ review.reviewComment != null }">
																			...
																			<div class="row commentBox modifyDiv"
																				...
																				<textarea class="ml-2 mr-1 mt-1 commentBox content"
																					style="resize: none; border: 1px solid #edeceb; height: 80px; border-radius: 4px; width: 90%">${ review.reviewComment }</textarea>
																				<button type="button"
																					class="btn mt-1 commentBox insertComment"
																					style="margin-bottom: 70px; height: 80px; border: 1px solid #dddddd; width: 70px;">수정</button>
																			</div>
																		</c:when>
																		<c:otherwise>
																			<div class="row commentBox" style="height: 110px;">
																				<input type="hidden" name="reviewNo"
																					value="${ review.reviewNo }" />
																				<textarea
																					class="col ml-2 mr-1 mt-1 commentBox content"
																					style="resize: none; border: 1px solid #edeceb; height: 80px; border-radius: 4px;"></textarea>
																				<button type="button"
																					class="btn mt-1 commentBox insertComment"
																					style="margin-bottom: 70px; height: 80px; border: 1px solid #dddddd; width: 70px;">등록</button>
																			</div>
																		</c:otherwise>
																	</c:choose>
																</div>
										...
										<c:otherwise>
											<div class="review nullImg mb-4 pb-3"
												style="border-bottom: .5px solid #efefef">
